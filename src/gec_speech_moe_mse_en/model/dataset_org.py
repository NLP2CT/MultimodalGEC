    ...
    def __init__(self, args, path, tokenizer,
        ...
        for i in range(len(self.examples)):
            if self.train:
                ...
                src_txt = example[fields[0]]


                tgt_txt = example[fields[-1]]
                ...
                # input_values = self.feature_extractor(waveform,sampling_rate=self.feature_extractor.sampling_rate, return_tensors="pt").input_values
...
class GECMultiModalDataset(GECMultiModalBaseDataset):
    def __getitem__(self, idx):
        ...
        sample = (source_text, tgt_text, speech, tgt_ids, tgt_mask)
