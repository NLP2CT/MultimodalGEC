...
def get_params():
    ...
    parser.add_argument("--summary_field", default='?�院?�况', type=str)
...
def main():
    ...
    #speech_joint_model = args.speech_joint_model
    ...
    if args.multimodal:
        ...
        if model_type == 'SpeechWithEncoderDecoderModel':
            ...
            # model2 = torch.load(args.speech_joint_model)
 ...
 #       print(p)
    ...
    if args.dataset_name == 'multimodal':
        ...
        if args.use_prompt:
            ...
            logging.info('load conll-14 eval data ... ')


            eval_dataset_conll14 = GECMultiModalDataset(args, path=args.test_file_conll14,
                                           tokenizer=tokenizer,
                                           fields=fields,
                                           symbols=symbols,
                                           is_train=True)
            ...
            logging.info('## conll14 ######################### ... ')
            logging.info('load conll14 test data ... ')
            ...
            logging.info('finish loading bea19 test data ... ')

            logging.info('## bea19 dev ######################### ... ')
            logging.info('load bea19 eval data ... ')

            eval_dataset_bea19_dev = GECMultiModalDataset(args, path=args.eval_file_bea19_dev,
                                           tokenizer=tokenizer,
                                           fields=fields,
                                           symbols=symbols,
                                           is_train=True)
            logging.info('finish loading bea19 eval data ... ')
    ...
    eval_dataloader_conll14 = MyDataLoader(args,
                                   tokenizer=tokenizer,
                                   feature_extractor=feature_extractor,
                                   shuffle=False,
    ...
    eval_dataloader_bea19 = MyDataLoader(args,
                                   ...
                                   feature_extractor=feature_extractor,
                                   shuffle=False,
                                   dataset=eval_dataset_bea19)

    eval_dataloader_bea19_dev = MyDataLoader(args,
                                   tokenizer=tokenizer,
                                   feature_extractor=feature_extractor,
                                   shuffle=False,
                                   dataset=eval_dataset_bea19_dev)
